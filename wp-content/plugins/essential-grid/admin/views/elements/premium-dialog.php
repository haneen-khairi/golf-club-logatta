<div id="esg-premium-benefits-dialog" class="esg-display-none">
	...
	<div id="basic_premium_benefits_block">
		...
		<div class="esg-premium-benefits-block esg-premium-benefits-block-instant-access">
			<h3></i><?php esc_html_e('Activate Essential Grid for', ESG_TEXTDOMAIN); ?> <span class="instant_access"><?php esc_html_e('instant access', ESG_TEXTDOMAIN); ?></span> <?php esc_html_e('to', ESG_TEXTDOMAIN); ?></h3>

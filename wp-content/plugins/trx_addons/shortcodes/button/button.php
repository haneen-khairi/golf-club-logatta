		...
		return apply_filters('trx_addons_sc_map', array(
			...
			"params" => array_merge(
					array(
                        ...
                        array(
                            "param_name" => "target",
                            "heading" => esc_html__("Open link", 'trx_addons'),
                            "description" => wp_kses_data( __("Open link URL in window", 'trx_addons') ),
                            'edit_field_class' => 'vc_col-sm-4',
                            "value" => array(
                                esc_html__('In this window', 'trx_addons') => 'self',
                                esc_html__('In new window', 'trx_addons') => 'blank',
                            ),
                            "type" => "dropdown"
                        ),

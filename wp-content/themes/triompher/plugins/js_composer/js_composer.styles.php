...
if ( !function_exists( 'triompher_vc_get_css' ) ) {
	add_filter( 'triompher_filter_get_css', 'triompher_vc_get_css', 10, 4 );
	function triompher_vc_get_css($css, $colors, $fonts, $scheme='') {
...
.vc_progress_bar.vc_progress_bar_narrow .vc_single_bar {
	background-color: {$colors['extra_link3_02']};
}

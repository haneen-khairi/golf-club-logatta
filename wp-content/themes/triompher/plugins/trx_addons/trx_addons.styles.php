...
if (!function_exists('triompher_trx_addons_get_css')) {
	add_filter('triompher_filter_get_css', 'triompher_trx_addons_get_css', 10, 4);
	function triompher_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.top_panel_custom_header-transparent-split-menu .scheme_default.sc_layouts_row_fixed_on {
	background-color: {$colors['bg_color']} !important;
}

.top_panel_custom_header-transparent-split-menu .scheme_dark.sc_layouts_row_fixed_on {
...
.sc_layouts_iconed_text_details span {
    color: {$colors['inverse_light']} !important;
}

.sc_layouts_iconed_text_link:hover .sc_layouts_iconed_text_details span {
...
ol[class*="trx_addons_list"][class*="_circle"] > li:before {
	color: {$colors['text_dark']};
}
...
.trx_addons_tooltip:after {
	border-top-color: {$colors['text_hover2']};
}
...
.sc_services_image_2 .sc_services_item_content {
	color: {$colors['extra_dark']};
	background-color: transparent;
}
...
.sc_team_item .trx_addons_hover_content .trx_addons_hover_text {
